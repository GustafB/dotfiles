...
-- insert empty lines
-- vim.api.nvim_set_keyvim.keymap.set("n", "<C-j>", [[:silent +g/\m^\s*$/d<CR>]], { noremap = true, silent = true })
-- vim.api.nvim_set_keyvim.keymap.set("n", "<C-k>", [[:silent -g/\m^\s*$/d<CR>]], { noremap = true, silent = true })
