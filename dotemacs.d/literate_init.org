...
#+BEGIN_SRC emacs-lisp
  ...
  (defun gb/rename-this-file (new-name)
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-}") 'gb/next-window)
  (global-set-key (kbd "C-{") 'gb/prev-window)
...
#+begin_src emacs-lisp
  (use-package general :ensure t
    ...
    (gb/leader-keys
      ...
      "d" '(:ignore t :which-key "File Management")
      "dd" '(gb/delete-this-file :wk "Delete this file")
      "dr" '(gb/rename-this-file :wk "Rename this file")
      "o" '(ace-window :wk "Switch window")
      "k" '(ace-delete-window :wk "Kill buffer")
...
#+begin_src emacs-lisp
  ...
  (use-package google-c-style
    :hook ((cc-mode c++-mode) . google-set-c-style))
...
#+begin_src emacs-lisp
  (use-package avy
    ...
    (gb/leader-keys
    "f" '(avy-goto-char-timer :which-key "go to char"))
...
#+begin_src emacs-lisp
  ...
  (use-package go-mode
    ...
    (go-mode . c-block-info-inline-mode)
    :init
...
** json
#+begin_src emacs-lisp
  (use-package json-ts-mode :ensure t :defer 20
    :custom
