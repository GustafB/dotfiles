...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-x C-r") 'counsel-projectile-find-file)
  (global-set-key (kbd "C-x C-d") 'counsel-projectile-find-dir)
  (global-set-key (kbd "C-x C-g") 'projectile-grep)
  (global-set-key (kbd "C-x C-t") 'projectile-switch-project)
...
#+begin_src emacs-lisp
  ...
  (use-package svelte-mode :ensure t :defer 10)
